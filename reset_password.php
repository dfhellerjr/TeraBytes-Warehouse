...
// Update customer account with the temporary password
...
<div id="reset">
	<div class="resetMessage">
		...
		<p>
			...
			to login to your customer account. For security purposes please change your temporary		password as soon as possible.							
		</p>
