...
if($customerid != 0)
{
	...
	if(isset($_POST['change_password']))
	{
		...
		$newPasswordAgain = test_input($_POST['new_password_again']);
		...
		if($count == 0)
		{
			$passwordMessage = "Password not found!";	
		}
		...
		else
		{
			...
			{
				$passwordMessage = "Password must be between 6-30 characters";
			}
			else
			{
				// Update password
	...
	if($passwordMessage != "")
	{
		echo 
		"<div id='messageGroup'>
			<p class='change-message'>$passwordMessage</p>
		 </div>";	
	}		
	else
	{
